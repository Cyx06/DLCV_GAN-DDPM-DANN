...
def arg_parse():
    ...
    parser.add_argument('--source',default="mnistm", type=str)
    parser.add_argument('--target',default="usps", type=str)
    ...
    parser.add_argument('--inf_testdata', type=str, default='../hw2_data/digits')
    parser.add_argument('--inf_target', type=str, default='svhn')
    parser.add_argument('--save_dir', type=str, default='./test_pred.csv',
                    help="path to the output csv file")

    #for test
    parser.add_argument('--image_dir', type=str, default='../hw2_data/digits/usps/data')
    parser.add_argument('--pre_label_path', type=str, default='./test_pred.csv')
    parser.add_argument('--model_path', type=str, default='bestMtoU.pth')
