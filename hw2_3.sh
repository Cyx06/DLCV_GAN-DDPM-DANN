...
if echo ${str} | grep ${usps};then
    python3 ./training/p3/predict.py --image_dir=$1  --pre_label_path=$2 --model_path="bestMtoU.pth"
elif echo ${str} | grep ${svhn};then
    python3 ./training/p3/predict.py --image_dir=$1  --pre_label_path=$2 --model_path="bestMtoS.pth"
fi
